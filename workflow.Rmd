...
1. [Etapas de uma Análise de Dados](#etapas)
1. [Uma Proposta de *Workflow*](#proposta)
1. [Etapas Abordadas neste Curso](#abordadas)
1. [Implementando o *SEU* Projeto](#seuprojeto)





# Etapas de uma Análise de Dados {#etapas}
...
# Uma Proposta de *Workflow* {#proposta}
...
# Etapas Abordadas neste Curso {#abordadas}
...
# Implementando o *SEU* Projeto {#seuprojeto}


## Implementando o *SEU* Projeto

- [Projeto no `R Studio`](#projeto-rstudio)
- [Programa de Importação](#importacao)
- [Documentação do Conjunto de Dados](#documentacao)
- [Programa de Crítica](#critica)
